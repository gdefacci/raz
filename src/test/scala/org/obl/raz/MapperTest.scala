...
//    var sc = Converter.tryConverter(Cl1.tupled, Cl1.unapply)
  ...
  @Test
  def testRootUri = {
    val u1 = Raz / "bbb" && ("a", "bb") && Param.int("par1") && ("b", "bbb") && Param.string("par2") && Param.boolean("par3")
...
//    var sc = Converter.tryConverter(Cl1.tupled, Cl1.unapply)
  ...
  @Test
  def testRootParams = {
    val u1 = Raz && ("a", "bb") && Param.int("par1") && ("b", "bbb") && Param.string("par2") && Param.boolean("par3")
